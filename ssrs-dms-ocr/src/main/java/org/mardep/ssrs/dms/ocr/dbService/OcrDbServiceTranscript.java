...
//		long docId = vd.uploadRequestTranscript("TODO", entity.getVesselName(), entity.getOfficialNumber(), entity.getImoNumber(), entity.getForDate(), entity.getApplicantCompanyName(), pdf);
//		if (docId < 0) {

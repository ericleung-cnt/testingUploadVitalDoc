...
@Repository
public class ClassSocietyJpaDao extends AbstractJpaDao<ClassSociety, String> implements IClassSocietyDao {

	@Override
	protected List<PredicateCriteria> resolvePredicateCriteriaList(final CriteriaBuilder cb, final Root<ClassSociety> listRoot) {

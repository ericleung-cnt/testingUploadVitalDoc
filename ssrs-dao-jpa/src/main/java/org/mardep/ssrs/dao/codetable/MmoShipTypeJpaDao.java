...
@Repository
public class MmoShipTypeJpaDao extends AbstractJpaDao<MmoShipType, String> implements IMmoShipTypeDao {
	
	@Override
	protected List<PredicateCriteria> resolvePredicateCriteriaList(final CriteriaBuilder cb, final Root<MmoShipType> listRoot) {

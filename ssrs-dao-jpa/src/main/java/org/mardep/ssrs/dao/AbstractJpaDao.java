...
//			}
	...
	private void resolveConditionList(List<PredicateCriteria> list, final Map<String, Criteria> map, final CriteriaBuilder cb, final List<Predicate> countPredicateList, final Root<T> countRoot, final List<Predicate> listPredicateList, final Root<T> listRoot){

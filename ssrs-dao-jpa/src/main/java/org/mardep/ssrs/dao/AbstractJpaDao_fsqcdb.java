...
public abstract class AbstractJpaDao_fsqcdb<T extends AbstractPersistentEntity<K>, K extends Serializable> implements IBaseDao<T,K> {
	...
	@PersistenceContext(unitName="fsqcPU_fsqcdb")

...
public abstract class AbstractDMI<T extends AbstractPersistentEntity<?>> {
	...
	public DSResponse remove(T entity, DSRequest dsRequest){
		logger.info("Remove: {}", dsRequest);
		DSResponse dsResponse = new DSResponse();
		dsResponse.setStatus(DSResponse.STATUS_SUCCESS);
		try {
	...
	protected DSResponse handleException(DSResponse dsResponse, Exception e) {
		...
		if (errorMessage == null || "".equals(errorMessage)) {
			errorMessage = e.getMessage() + "<br/><br/>Please contact administrator or try again later.";
		}
	...
	protected DSResponse handleException(DSResponse dsResponse, String errorMessage) {
		Date now = new Date();
		dsResponse.setData(now.toString() + ":" + "<br/><br/>" + errorMessage);

...
@Component
public class ExcelNoteShipRegDMI {
	...
	public DSResponse fetch(ExcelNoteShipReg entity, DSRequest dsRequest) {
		...
		try {
			...
			List<ExcelNoteShipReg> ships = shipRegSvc.getNoteShipRegInMonth(fromDate, toDate);
...
//				List<ExcelNoteShipReg> ships = shipRegSvc.getNoteShipRegInMonth(asDate);
//				dsResponse.setData(ships);
//				dsResponse.setStatus(DSResponse.STATUS_SUCCESS);
//				//return dsResponse;
//			}
...
//	public DSResponse update(ExcelNoteShipReg entity, DSRequest dsRequest) {
//		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");		
//		DSResponse dsResponse = new DSResponse();
//		try {
//			Map suppliedValues = dsRequest.getClientSuppliedValues();
//		
//			if (suppliedValues.containsKey("regDate")) {
//				Date asDate = sdf.parse(suppliedValues.get("regDate").toString());
//				List<ExcelNoteShipReg> ships = shipRegSvc.getNoteShipRegInMonth(asDate);
//				dsResponse.setData(ships);
//				dsResponse.setStatus(DSResponse.STATUS_SUCCESS);
//				//return dsResponse;

...
var apmSectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Ship Manager<br /></font></b></p>"
	});
...
var apmForm_p1 = 
	isc.DynamicForm.create({
		...
		fields: [
			...
			{ name: "ship_manager", title: "Ship Manager", type: "text", width: "300", colSpan:3, endRow: true
			} , 
			{ name: "imo_comp_id", title: "IMO Company ID", type: "text", width: "70", endRow: true
			} , 
			{ name: "address_f1", title: "Address", type: "text", width: "300", colSpan: 3, endRow: true
			}, 
			{ name: "address_f2", title: "", type: "text", width: "300", colSpan: 3, endRow: true
			}, 
			{ name: "address_f3", title: "", type: "text", width: "300", colSpan: 3, endRow: true
			}

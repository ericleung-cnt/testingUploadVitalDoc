...
function openSrDemandNote(record){
	...
	var form = isc.DynamicForm.create({
		...
		fields:[
			...
			{name:"officeCode", title:"Office Code", type:"staticText", colSpan:3},
...
var sectionTitle =
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Transcript Application Record<br /></font></b></p>"
	});

var searchSection =
	isc.ListGrid.create({
		dataSource : "transcriptApplicationDS2",
		showFilterEditor:true,
...
var btns = isc.ButtonsHLayout.create({
	members : [
		isc.IAddButton.create({ title:"Create<br>Demand Note", height:thickBtnHeight, width:120, click:"openSrDemandNote({type:\"Regular\"}, null, 0)"}),
...
var transcript_form =  isc.VLayout.create(
			 { members:
	[
...
var contentLayout =
	...
	height: "100%",
	padding: 10,
    members: [ sectionTitle, searchSection, transcript_form, btns ]
	members:[
		 isc.SectionStack.create({
			 sections:[
				 { title: "Search", expanded:true, resizeable:false, items:[searchSection]},
				 { title: "Transcript Application", expanded:true, resizeable:false, items:[transcript_form, btns]}
			 ]
		 })
	 ]
});*/
...
var filterListGrid = isc.FilterListGrid.create({
		...
		fields: [
			 ...
			 { name:"reason", width:140, title:"Reason of No Payment" },
			 ...
			 { name:"generationTime", title:"Issue Date", type:"date", width:150, format:"dd/MM/yyyy"},
		...
		rowClick : function(record, recordNum, fieldNum){
			...
			dynamicForm.getItem("generationTime").setDisabled(DemandNoteIND);
...
/*function getDemandNote(){
	return "051600000012191";
}*/
...
var saveButton = isc.ISaveButton.create({
	...
	lazy:function(){
		...
		dynamicForm.getItem("demandNoteNo").setValue(getDemandNote());
	}
});
...
/*
createCodeTable3(transcriptApplicationDS2, 
	[
		 { name: "id"}, 
		 { name:"applNo", width:100 },
		 { name:"demandNoteNo", width:140 , title:"Demand Note No.", type:"staticText", colSpan:3},
		 { name:"generationTime", title:"Issue Date", type:"date", width:150, format:"dd/MM/yyyy"},
		 { name:"officeCode", width:100 }
	],
	
	[
		{name:"applNo", title:R"Appl No.", width:100},
		 ...
		 { name:"generationTime", title:"Issue Date", type:"date", width:80, format:"dd/MM/yyyy"},
		 { name:"officeCode", width:80 }
		  {name:"applNo", required:true, title:"Appl No.", width:200, changed:function(form, item, value) {
			  form.getItem("zip").setValue(value.includes(","));
		  },},
		  {name:"generationTime", title:"Issue Date", type:"date", width:200, format:"dd/MM/yyyy" , startRow:"true"},
		  {name:"reportDate", type:"datetime", required:true, defaultValue:new Date(), title:"Report Date", width:200, dateFormatter:"dd/MM/yyyy HH:mm" , startRow:"true" },
		  {name:"printBy",required:true, valueMap:{"HQ":"Headquarter","RD":"Regional Desk"}, displayField:"name", valueField:"id", title:"Report generate by", width:200 , startRow:"true"},
		  {name:"DemandNoteNo", title:"Demand Note No", startRow:"true" },
		  {name:"registrar", optionDataSource:"registrarDS", startRow:"true", displayField:"name", valueField:"id", title:"Registrar", width:200},
		  {name:"certified", type:"boolean", title:"Certified" , startRow:"true"},
		  {name:"paymentRequired", type:"boolean", title:"Payment Required", changed:function(_1,_2,_3){
			  this.form.getItem("reason").setEnabled(!this.getValue());
			  }},
		  {name: "paymentStatus", title:"Payment Status", startRow:"true",	width:120, valueMap:{"0":"Outstanding", "1":"Paid (Full)", "2":"Outstanding (Partial)", "3":"Paid (Overpaid)", "4":"Autopay Arranged"}} ,
		  {name:"reason", title:"Reason", startRow:"true" },
		  {name:"printMortgage", type:"boolean", title:"Print Mortgage", },
		  {name:"zip", type:"boolean", value:false, visible:false}
	],
	["id"], 'paged');*/

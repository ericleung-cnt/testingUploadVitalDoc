...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Summary of Receipt Collected</font></b></p>"
	});
...
var searchForm = 
	isc.ReportDynamicForm.create({
		...
		numCols: 6,	
		fields: [
					{name: "demand_note_date_from", title: "Date From", type: "date", displayFormat:"dd/MM/yyyy"}, 
					{name: "demand_note_date_to", 	title: "Date To", 	type: "date", displayFormat:"dd/MM/yyyy", endRow: true}
				]
	});
	...
	isc.ReportToolbar.create({
		buttons: [
			{ name:"generateBtn", title:"Generate Report", autoFit: true, disabled: false,
			  click : function () { 
				  if(RPT_FIN_006_Form.validate()){
						ReportViewWindow.displayReport(["RPT_FIN_006", RPT_FIN_006_Form.getValues()]);
					}
			  }
			}
		]

...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Fully Paid Demand Note Details Report</font></b></p>"
	});
	...
	isc.ReportToolbar.create({
		buttons: [
			{ name:"generateBtn", title:"Generate Report", autoFit: true, disabled: false,
			  click : function () { 
				  if(RPT_FIN_004_Form.validate()){
						ReportViewWindow.displayReport(["RPT_FIN_004", RPT_FIN_004_Form.getValues()]);
					}
			  }
			}
		]

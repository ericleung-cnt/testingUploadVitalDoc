...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Summary of Generated Demand Note</font></b></p>"
	});
	...
	isc.ReportToolbar.create({
		buttons: [
			{ name:"generateBtn", title:"Generate Report", autoFit: true, disabled: false,
			  click : function () { 
				  if(RPT_FIN_002_Form.validate()){
						ReportViewWindow.displayReport(["RPT_FIN_002", RPT_FIN_002_Form.getValues()]);
					}
			  }
			}
		]

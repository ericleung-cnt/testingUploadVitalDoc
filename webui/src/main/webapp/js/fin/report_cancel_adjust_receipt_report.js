...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Cancelled / Adjusted Receipt Report</font></b></p>"
	});
	...
	isc.ReportToolbar.create({
		buttons: [
			{ name:"generateBtn", title:"Generate Report", autoFit: true, disabled: false,
			  click : function () { 
				  if(RPT_FIN_007_Form.validate()){
						ReportViewWindow.displayReport(["RPT_FIN_007", RPT_FIN_007_Form.getValues()]);
					}
			  }
			}
		]

...
@Service("oldDemandNoteGeneratorMMO")
@Transactional
public class OldDemandNoteGeneratorMMO extends AbstractOldDemandNoteGenerator{

	@Override
	public String getReportFileName() {
		return "OldDemandNoteMMO.jrxml";
	}
...
//		List of DemandNote Item
		...
		for(DemandNoteItem x:itemList){
			...
			bean.setFeePrice(code.getFeePrice());
			bean.setChargedUnit(x.getChargedUnits());
			listOfEntity.add(bean);
		}
		map.put("barCodeNo", getBarcode(dnHeader, Cons.SSRS_MMO_OFFICE_CODE, revenue));

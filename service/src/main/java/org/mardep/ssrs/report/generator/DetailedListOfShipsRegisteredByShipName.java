...
@Service("detailedListOfShipsRegisteredByShipName")
@Transactional
public class DetailedListOfShipsRegisteredByShipName extends AbstractReportGenerator implements IReportGenerator{
	...
	//private final String FIELD_OWNER_ADDRESS = "ownerAddress";
	...
	public String getReportFileName() {
		...
		return "DetailedListOfShipsRegisteredByShipName.jrxml";
	}
	...
	public byte[] generate(Map<String, Object> inputParams) throws Exception {
		...
		for (RegisteredShip ship:ships) {
			...
			//row.put(FIELD_OWNER_ADDRESS, owner.address());
			rows.add(row);
		}

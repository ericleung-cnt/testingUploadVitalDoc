...
public class RPT_FIN_DemandNoteStatus extends AbstractFinReport {
	...
	private void fillData01(Map<String, Object> inputParam){
		...
		for(Object[] object:list){
			...
			List<DemandNoteItem> dniList = demandNoteItemDao.findByDemandNoteNo(dnNo);
			if(dniList!=null && dniList.size()>0){
//				rc01.setFeeCode(dniList.get(0).getFcFeeCode());
				rc01.setFeeCode(dniList.get(0).getFeeCode().getFormCode());
			}

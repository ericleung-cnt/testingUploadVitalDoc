...
public class DemandNoteService extends AbstractService implements IDemandNoteService{
	...
	public List<DemandNoteItem> searchDemandNoteNo(String applNo){
		return demandNoteHeaderDao.searchDemandNoteNo(applNo);
	}
	/**
	 * TODO
	 * @param pk
...
//		String demandNoteNo = generateNextDemandNoteNo();
		...
		if (rm!=null) {
			...
			header.setNetTon(rm.getGrossTon());
		}
...
//			e.printStackTrace();
//		}
		//20190806 ControlData newCD = controlDataDao.save(controlData);
...
//		logger.info("dns processed {} {}", header.getDemandNoteNo(), dnsResp.getProcessed());
	...
	public void createAtcItem() {
		...
		map.put("regStatus", new Criteria("atfDueDate", "R"));

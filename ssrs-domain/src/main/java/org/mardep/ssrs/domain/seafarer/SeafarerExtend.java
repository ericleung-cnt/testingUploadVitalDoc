...
@NoArgsConstructor
@Entity
@Table(name="vMMO_SeafarerExtend")
@Immutable
public class SeafarerExtend extends AbstractPersistentEntity<String>  {
...
//	@Enumerated(EnumType.ORDINAL)
	...
	@Setter
	@Getter
	@Column(name="LATEST_REGISTRATION_RECORD_DATE")
	@Temporal(TemporalType.DATE)
	private Date latestRegistrationRecordDate;
	
	@Setter
	@Getter
	@Column(name="LATEST_REGISTRATION_EXPIRY_DATE")
	@Temporal(TemporalType.DATE)
	private Date latestRegistrationExpirydate;
}
